...
export const SpeakerCard = ({ name, topic, job, imageUrl, aosDelay }: SpeakerCardProps) => {
  return (
    <div data-aos="fade-down" data-aos-delay={aosDelay} className="p-10 w-full h-56 sm:h-60 max-w-md mx-auto rounded-xl text-center bg-white hover:bg-invofest_secondary transition-all border-invofest border-4 relative group shadow-lg shadow-invofest_dark">
